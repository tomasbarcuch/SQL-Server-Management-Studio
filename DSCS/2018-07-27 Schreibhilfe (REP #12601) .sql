...
left join dbo.[Translation] T on S.ID = T.entityId and language = 'DE' and s.disabled = 'false'
left outer join 
 (select
...
and S.Name = 'lpPacked' and sdate.StatusChanged between '2018-07-01' and '2018-07-31'
and case when s.name = 'lpPacked' then 1 else 0 end in (0,1) --in  ($P{JustPacked},1)
...
and sdate.StatusChanged between '2018-06-01' and '2018-07-31'
and case when s.name = 'huPacked' then 1 else 0 end in (0,1) --in  ($P{JustPacked},1)