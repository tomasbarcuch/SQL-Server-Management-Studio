...
left join dbo.Translation T on S.id = T.EntityId and t.[Language] = 'DE' --on DATA. = dim.entityID and lp.ClientBusinessUnitId = dim.ClientBusinessUnitId and dim.entity in (11,15)
