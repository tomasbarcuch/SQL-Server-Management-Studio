...
set @dateto = '2019-02-28'


use DFCZ_OSLET

Select
year(loglist.LogDate) as 'Year',
month(loglist.LogDate) as 'Month',
BUname,
logged,
...
SELECT cast ([LogTime] as date) as LogDate
  ...
  group by BUname,loglist.logged,year(loglist.LogDate),month(loglist.LogDate)
  order by BUname, logged

--=====================================================================================================================

select
Year(case WHEN WE.QuantityBase > 0 and we.LocationId is not null then cast(RegisteringDate as date) else null end) as 'Year',
Month(case WHEN WE.QuantityBase > 0 and we.LocationId is not null then cast(RegisteringDate as date) else null end) as 'month',
bu.name as 'Busines unit',
count(distinct(lp.Code)) 'Lose Parts Inbound',
sum(case WHEN WE.QuantityBase > 0 and we.LocationId is not null then lp.BaseArea else null end) as 'Basearea',
...
where (case WHEN WE.QuantityBase > 0 and we.LocationId is not null then cast(RegisteringDate as date) else null end ) between @DATEFROM and @dateto
group by 
bu.name,
Year(case WHEN WE.QuantityBase > 0 and we.LocationId is not null then cast(RegisteringDate as date) else null end),
Month(case WHEN WE.QuantityBase > 0 and we.LocationId is not null then cast(RegisteringDate as date) else null end)

--================================================================================================================================================

select 
year(data.packeddate) as 'Year',
month(data.packeddate) as 'Month',
data.bu as 'Busines unit',
count(distinct(data.Code)) 'Packed HUs',
sum(data.PackedBaseAre) as 'Packed HUs BaseArea',
sum(data.PackedSurface) as 'Packed HUs Surface',
...
case WHEN WE.QuantityBase > 0 and we.LocationId is not null and we.LoosepartId is not null then HU.Surface else null end as PackedSurface,
case WHEN WE.QuantityBase > 0 and we.LocationId is not null and we.LoosepartId is not null then HU.BaseArea else null end as PackedBaseAre
...
HU.BaseArea,
HU.Surface,
case WHEN WE.QuantityBase > 0 and we.LocationId is not null and we.LoosepartId is not null then HU.BaseArea else null end,
case WHEN WE.QuantityBase > 0 and we.LocationId is not null and we.LoosepartId is not null then HU.Surface else null end,
...
group by 
data.bu,
year(data.packeddate),
month(data.packeddate)

--===================================================================================================================


select 
Year(data.Dispatcheddate) as 'Year',
Month (data.Dispatcheddate) as 'Month',
data.bu as 'Busines unit',

count(distinct(data.Code)) 'count',
sum(data.Dispatched) as 'DispatchedBaseArea',
...
group by 
data.bu,
Year(data.Dispatcheddate),
Month (data.Dispatcheddate)

--==========================================================================================================================================

select 
year(LoadingDateTime) as 'Year',
month(LoadingDateTime) as 'Month',
BusinessUnit,
Sum(SHs) as 'SHs',
...
where (LoadingDateTime) between @DATEFROM and @dateto
group by BusinessUnit,
year(LoadingDateTime),
month(LoadingDateTime)
...
left join BusinessUnit BUpa on BUR.RelatedBusinessUnitId = BUpa.id
 ...
 and Calendar.date between cast(@datefrom as date) and cast(@dateto as date)
