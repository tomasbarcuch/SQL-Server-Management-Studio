...
SELECT T1.Entity, isnull(LP.Code,HU.code) as Code,isnull(T.text,S.Name) as Status, T1.[Date] 'start', --T2.[Date] 'end', 
...
-- and Dimensions.Project not in  ('VT0000TEST')
--and LP.code = 'LPKR-009417'
