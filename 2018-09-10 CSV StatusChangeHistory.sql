...
inner JOIN customfield CF_SG on BUPs.BusinessUnitId = CF_SG.clientbusinessunitid and CF_SG.name = 'Sperrlager Gründe'
inner JOIN customvalue CV_SG on CV_SG.customfieldid = CF_SG.Id and CV_SG.EntityId = WFE.EntityId



where BUPs.BusinessUnitId = 'ad5a5f6b-8ec4-463b-836a-0a8cb60a39d2' and wfe.Entity <> 10
